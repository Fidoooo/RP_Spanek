...
## Hardware
Naším cílem je, abychom zprovoznili všechny potřebné senzory (akcelerometr[^2], oxymetr) a až pak se budeme zabývat velikostí a designem, ale i tak se chceme inspirovat již existujícími zařízeními na monitorování spánku jako například WHOOP 4.0, Oura Ring a Garmin. Uvědomujeme si ale naše limitace ze strany velikosti a funkčnosti, proto je to spíše lehká inspirace v oblasti vzhledu.
